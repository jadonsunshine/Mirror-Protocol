  ...
  return (
    <TabsContent value="campaigns" className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
       ...
       <div className="bg-white p-6 md:p-8 rounded-[2rem] border border-slate-200 shadow-[0_12px_28px_-6px_rgba(15,23,42,0.08)] flex flex-col md:flex-row items-center justify-between gap-6 relative overflow-hidden hover:-translate-y-1 transition-transform duration-300">
          ...
          <div className="absolute -right-6 -bottom-8 text-[140px] font-black text-green-50 opacity-60 z-0 select-none pointer-events-none tracking-tighter leading-none">
             SUCCESS
          </div>
          ...
          <div className="flex-1 space-y-2 w-full pl-2 relative z-10">
             ...
             <div className="flex items-center gap-4 text-sm mt-4">
                {/* 🚨 RECESSED DATA PILL (Like the inspiration image) */}
       ...
       <div className="bg-white p-6 md:p-8 rounded-[2rem] border border-slate-200 shadow-[0_12px_28px_-6px_rgba(15,23,42,0.08)] flex flex-col md:flex-row items-center justify-between gap-6 relative overflow-hidden hover:-translate-y-1 transition-transform duration-300">
          ...
          {/* 🚨 THE WATERMARK BACKGROUND */}
          <div className="absolute -right-6 -bottom-8 text-[140px] font-black text-orange-50 opacity-60 z-0 select-none pointer-events-none tracking-tighter leading-none">
             ACTIVE
          </div>
          ...
          <div className="flex-1 space-y-2 w-full pl-2 relative z-10">
             ...
             {/* 🚨 INSPIRATION: GLOWING PROGRESS BAR */}
             <div className="w-full max-w-md bg-slate-100 rounded-full h-3 mt-5 overflow-hidden shadow-[inset_0_2px_5px_rgba(0,0,0,0.1)] border border-slate-200/50 p-0.5">
                <div 
                   className="bg-gradient-to-r from-[#FF6B4A] to-[#FF3D71] h-full rounded-full shadow-[0_0_12px_rgba(255,107,74,0.8)] relative" 
                   style={{ width: "45%" }} 
                >
                   {/* Inner highlight to make the bar look 3D */}
       ...
       <div className="bg-slate-50 p-6 md:p-8 rounded-[2rem] border border-slate-200 shadow-[inset_0_4px_20px_rgba(0,0,0,0.02)] flex flex-col md:flex-row items-center justify-between gap-6 relative overflow-hidden opacity-80 grayscale-[0.5] hover:grayscale-0 transition-all duration-500">
          ...
          {/* 🚨 THE WATERMARK BACKGROUND */}
          <div className="absolute -right-6 -bottom-8 text-[140px] font-black text-slate-200 opacity-40 z-0 select-none pointer-events-none tracking-tighter leading-none">
             FAILED
          </div>
